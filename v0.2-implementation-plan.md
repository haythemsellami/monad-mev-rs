...
|---|---|---|
| v0.2-A | Execution Events stream and protocol capture | No |
| v0.2-B | Strategy packages and engine runtime | No |
| v0.2-C | Protocol state stores and read-only opportunities | No |
...
The first concrete v0.2 target is a read-only liquidation detector. It should run
...
- Add abstractions only where v0.1 APIs become insufficient for real protocol
...
Goal: provide the first v0.2 strategy template over protocol capture/state.
...
- `docs/v0.2/liquidation-read-only.md`
