...
- [ ] Preserve v0.1 `StreamItem` variants.
...
- [ ] Add reusable capture presets that external packages can compose.
...
- [ ] Extend `strategy new` for v0.2 strategy packages.
...
- [ ] Define typed state update envelope.
- [ ] Define projection trait.
- [ ] Add deterministic update ordering.
- [ ] Add source event reference model.
- [ ] Add fixture projection helper.

Testing tasks:

- [ ] Projection update test.
- [ ] Deterministic ordering test.
- [ ] Source event reference test.
- [ ] Unknown key fallback test.
...
- [ ] Add adapter metadata model.
- [ ] Define event adapter trait.
- [ ] Define state adapter trait.
- [ ] Define opportunity detector trait.
- [ ] Define adapter capability flags.
- [ ] Add boxed adapter support.
- [ ] Add adapter error type.
...
- [ ] Event adapter test.
- [ ] State adapter test.
- [ ] Opportunity detector test.
- [ ] Boxed adapter dispatch test.
...
- [ ] Add generic monitor strategy package.
- [ ] Subscribe to configured capture filters.
- [ ] Read adapter-produced opportunities.
...
- [ ] Missing adapter state warning test.
...
- [ ] Define fixture domain event.
- [ ] Define fixture state model.
- [ ] Add adapter trait implementation for fixture events.
- [ ] Add opportunity condition.
- [ ] Add incomplete/stale state handling.
- [ ] Add replay fixture implementation.

Testing tasks:

- [ ] Fixture state validation.
- [ ] State update test.
- [ ] Stale/incomplete state behavior.
...
- [ ] Define package manifest model.
- [ ] Define package capability metadata.
- [ ] Define subscription declarations.
- [ ] Define strategy factory trait.
- [ ] Add manifest validation.

Testing tasks:

- [ ] Manifest validation test.
- [ ] Subscription declaration test.
- [ ] Package metadata serialization test.
...
- [ ] Opportunity serialization test.
...
- [ ] Add read-only lifecycle strategy.
- [ ] Subscribe to fixture domain captures.
- [ ] Read state projection.
- [ ] Reject non-matching state.
- [ ] Reject stale state.
- [ ] Emit structured opportunity records.
- [ ] Add CLI scaffold/template hook.

Testing tasks:

- [ ] Non-matching state ignored.
- [ ] Matching state emits opportunity.
- [ ] Stale state rejects opportunity.
- [ ] Incomplete state rejects opportunity.
- [ ] Golden JSONL output.
...
- [ ] Add source event fixture.
- [ ] Add state update fixture.
- [ ] Add opportunity fixture.
- [ ] Add matching and non-matching cases.
- [ ] Add stale state case.
- [ ] Add golden opportunity JSONL.
...
- [ ] Add external-data freshness and simulation freshness checks.
- [ ] Add circuit breaker.
...
- [ ] Add transaction candidate builder trait.
- [ ] Add simulation integration.
- [ ] Add value estimate hook.
...
- [ ] Update getting-started docs for v0.2.
...
These decisions should be resolved before adapter and execution work becomes too
concrete:
