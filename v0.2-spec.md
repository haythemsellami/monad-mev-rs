...
v0.2 should support exact math for supported pool families before enabling
strategy templates that depend on it.

### 8.2 Lending State

v0.2 lending state should include:
...
## 12. Liquidation v0.2 Target

The first v0.2 strategy target should be a staged liquidation workflow:
...
4. Should async traits replace v0.1 sync strategy traits, or should v0.2 add an
...
9. Should v0.2 publish crates or remain Git-only until production executor APIs
   stabilize?
